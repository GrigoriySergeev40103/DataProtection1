...
namespace DataProtection1
{
	internal static class EncrypterKeyGenerator
	{
		...
		public static (DesCfbEncrypter.EncryptionData, DesCfbEncrypter.CfbData) GenerateCfbEncrypter()
		{
			(DesCfbEncrypter.EncryptionData, DesCfbEncrypter.CfbData) result = new();
